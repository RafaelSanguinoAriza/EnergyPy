<script lang="ts">
  ...
  import { LayoutDashboard, Zap, Settings } from "@lucide/svelte";
...
<aside class="w-16 lg:w-56 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex flex-col items-center lg:items-stretch py-4 gap-1 shrink-0">
  <div class="px-3 lg:px-4 mb-6 flex items-center justify-center lg:justify-start gap-2">
    <div class="w-8 h-8 bg-gradient-to-br from-energy-500 to-energy-700 rounded-lg flex items-center justify-center shadow-lg shadow-energy-500/20 group-hover:shadow-energy-500/40 transition-shadow duration-300">
