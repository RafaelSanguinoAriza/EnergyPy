...
[![Version](https://img.shields.io/badge/Version-2.0.1-energy)](CHANGELOG.md)

</div>

EnergyPy es una aplicación de escritorio moderna, ligera y de alto rendimiento diseñada para el monitoreo de recursos del sistema en tiempo real y el control de energía.
...
- **Dashboard en vivo** — Uso de CPU (por núcleo y temperatura), memoria, disco, red, tiempo de actividad y batería, actualizado cada N segundos (configurable).
- **Gestor de procesos** — Tabla completa con 50 procesos, búsqueda por nombre/PID, ordenación por columnas, ruta del ejecutable, tiempo de inicio, y finalización individual o masiva.
...
- **Atajos de teclado** — `Ctrl+C` (cancelar), `Ctrl+T` (tema), `Ctrl+Q` (salir).
- **Actualización automática** — Mecanismo integrado vía GitHub Releases.
- **Inicio automático** — Opción para iniciar con el sistema operativo.
- **Skeleton loaders** — Indicadores de carga animados mientras se obtienen los datos.
- **Notificaciones toast** — Alertas emergentes para confirmaciones y errores.
...
> Al no estar firmado digitalmente, Windows SmartScreen puede mostrar un aviso en la primera ejecución (tanto en el instalador como en la versión portátil).
...
| Sección | Descripción |
|---|---|
| **Dashboard** | Monitoreo en tiempo real de todos los recursos del sistema (CPU, memoria, disco, red, batería) |
| **Procesos** | Gestor de procesos con búsqueda, ordenación y finalización de procesos |
| **Control de Energía** | Programa acciones de energía con temporizador o a hora exacta |
| **Configuración** | Idioma, tema, notificaciones, inicio automático y atajos de teclado |
...
# Si no funciona el servidor de desarrollo, borrar caché de Tauri
...
**Rafael David Sanguino Ariza** — [GitHub](https://github.com/RafaelSanguinoAriza)
